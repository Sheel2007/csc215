...
int main() {
    ...
    do {
        ...
        switch(option) {
            case 1:
                printf("\n Enter first distance in kms and meters: ");
            ...
            case 3: 
                ...
                printf("\n The sum of the two distances is : %d kms %d meters", d3.kms, d3.meters);
                break;
            case 4:
                d4 = subtract_distance(d1, d2);
                printf("\n The difference between the two distances is : %d kms %d meters", d4.kms, d4.meters);
                break;
        }
    }while(option != 5);
    getch();
